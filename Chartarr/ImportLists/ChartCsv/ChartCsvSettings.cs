...
namespace Chartarr.ImportLists.ChartCsv
{
    ...
    public class ChartCsvSettings : IImportListSettings
    {
        ...
        // unused; required by IImportListSettings
        ...
        [FieldDefinition(2, Label = "Match confidence (%)", Type = FieldType.Number, Advanced = true,
            HelpText = "Rows whose best match scores below this are passed to Lidarr by name instead. Title and artist similarity floors always apply on top.")]
